...
if __name__ == "__main__":
    ...
    print("=" * 74)
    print("  ENGINE  | ML Brain (sklearn) + LLM Expert (Ollama/Mistral)")
    print("  DATA    | DDGS Live Search - fresh every query, no stale data")
    print("=" * 74)
    print("  LIVE    | score | situation | run rate | batting | bowling")
    print("  MATCH   | today | toss analysis | pitch | weather | playing 11")
    print("  INTEL   | news | injury | fantasy | orange cap | purple cap")
    print("  ANALYSIS| Virat analysis — ML + LLM expert | form | milestone")
    print("  PREDICT | win probability | player next score | wickets")
    print("  COMPARE | compare Virat and Rohit | bowler vs batsman")
    print("  VALUE   | auction price | team strength | H2H")
    print("  GRAPHS  | batting graph | bowling graph | momentum dashboard")
    print("  TABLE   | points table | schedule | records")
    print("  AUTO    | Wicket alerts | Milestone | Partnership | RR")
    print("=" * 74)
    print()
    print(f"  LLM Status: {check_llm_status()}")
    print("=" * 74)
    print()
